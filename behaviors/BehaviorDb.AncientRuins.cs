    ...
    partial class BehaviorDb
    {
        private _ AncientRuins = () => Behav()
            ...
            new State(
                ...
                new State("serious",
                    ...
                    new Shoot(15, 4, 15, projectileIndex: 1, predictive: 1, coolDown: 500),
        ...
        .Init("Sand Golem", // sand golem
            new State(
                new State("nobossnear",
                    ...
                    new Shoot(20, 2, 10, 0, predictive: 1, coolDown: 1000),
        ...
        .Init("Sand Salamander",
            new State(
                ...
                new Shoot(10, 3, 15, 0, predictive: 1, coolDown: 1000)
                )
            )
        .Init("Sand Slurp",
            new State(
                ...
                new Shoot(15, 1, projectileIndex: 0, predictive: 1, coolDown: 500)
                )
            )
        .Init("Sand Maggot",
            new State(
                ...
                new State("defend",
                    ...
                    new Shoot(15, 3, 20, projectileIndex: 0, predictive: 1, coolDown: 1500)
                    )
                )
            )
        .Init("Sand Eater",
            new State(
                new State("defend",
                    ...
                    new Shoot(7, 1, projectileIndex: 0, predictive: 1, coolDown: 2000)
                    )
                )
            )
        .Init("Sand Archer",
            new State(
                ...
                new Shoot(10, 2, 10, 0, predictive: 1, coolDown: 400)
                )
            );
    }
}
